# Support for Output Descriptors in Wiocoin Core

Since Wiocoin Core v0.17, there is support for Output Descriptors. This is a
...
on Wiocoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Wiocoin Core wallets, a convenience function `combo` is
