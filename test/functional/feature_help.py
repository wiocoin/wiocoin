...
"""Verify that starting wiocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start wiocoin with -h for help text")
        ...
        self.log.info("Start wiocoin with -version for version information")
        ...
        self.log.info("Start wiocoind with -fakearg to make sure it does not start")
