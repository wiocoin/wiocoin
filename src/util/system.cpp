...
const char * const BITCOIN_CONF_FILENAME = "wiocoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Wiocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Wiocoin";
#else
    // Unix
    return pathRet / ".wiocoin";
#endif
#endif
}
