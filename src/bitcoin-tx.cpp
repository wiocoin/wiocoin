...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " wiocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  wiocoin-tx [options] <hex-tx> [commands]  Update hex-encoded wiocoin transaction\n" +
            "or:     wiocoin-tx [options] -create [commands]   Create hex-encoded wiocoin transaction\n" +
            "\n";
